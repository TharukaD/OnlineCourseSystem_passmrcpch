...
public class StudyMaterialService : IStudyMaterialService
{
	...
	public async Task<IEnumerable<StudyMaterial>> GetAll(int? categoryId = null)
	{
		if (categoryId != null)
		{
			return await _context.StudyMaterials
				.Where(r => r.StudyMaterialCategoryId == categoryId)
	...
	public async Task<IEnumerable<StudyMaterial>> GetAllPublished(int? categoryId = null)
	{
		if (categoryId != null)
		{
			return await _context.StudyMaterials
